...
{
       0,    37,    37,    38,    39,    40,    41,    45,    47,    49,
      51,    53,    55,    57,    59,    61,    63,    66,    67,    68,
      69,    72,    84,    96,   108,   122,   123,   126,   133,   134,
     137,   142,   149,   150,   153,   160,   161,   164
};
#endif
...
{
  "$end", "error", "$undefined", "type", "id", "int_val", "float_val",
  "double_val", "char_val", "int_type", "float_type", "double_type",
  "char_type", "semicolon", "cama", "op", "cp", "ob", "cb", "equal",
  "plus", "minus", "mult", "divs", "and", "or", "done", "$accept", "start",
  "program", "operation", "exp", "term", "factor", "number", "declaration",
  "int_var", "float_var", "double_var", "char_var", YY_NULLPTR
};
#endif
...
{
      -4,     9,    13,    17,    21,    31,   -13,    36,   -13,   -13,
     -13,     5,    20,   -12,    22,   -10,    23,     2,    24,    10,
     -13,   -13,   -13,   -13,   -13,   -13,     5,     6,     7,   -13,
     -13,    35,   -13,    13,    26,   -13,    17,    37,   -13,    21,
      38,   -13,    31,    -2,     5,     5,     5,     5,   -13,    33,
     -13,   -13,    34,   -13,    39,   -13,    40,   -13,     7,     7,
     -13,   -13
};
...
{
       5,     0,     0,     0,     0,     0,     6,     0,     2,     4,
       3,     0,    26,     0,    29,     0,    33,     0,    36,     0,
       1,    15,    17,    19,    18,    20,     0,     7,     8,    11,
      14,     0,    21,     0,     0,    22,     0,     0,    23,     0,
       0,    24,     0,     0,     0,     0,     0,     0,    27,    25,
      31,    30,    28,    34,    32,    37,    35,    16,     9,    10,
      12,    13
};
...
{
       1,    32,    33,    35,    36,     2,     3,     4,     5,    21,
      22,    23,    24,    25,    57,    38,    39,    12,    44,    45,
      26,    14,     6,    41,    42,    16,    44,    45,    11,    46,
      47,    50,    51,    58,    59,    18,    20,    60,    61,    31,
      48,    34,    37,    40,    53,    43,    55,    33,    36,    49,
      52,    54,     0,    39,    42,     0,     0,    56
};

static const yytype_int8 yycheck[] =
{
       4,    13,    14,    13,    14,     9,    10,    11,    12,     4,
       5,     6,     7,     8,    16,    13,    14,     4,    20,    21,
      15,     4,    26,    13,    14,     4,    20,    21,    19,    22,
      23,     5,     6,    44,    45,     4,     0,    46,    47,    19,
       5,    19,    19,    19,     7,    26,     8,    14,    14,    33,
      36,    39,    -1,    14,    14,    -1,    -1,    42
};
...
{
       0,     4,     9,    10,    11,    12,    26,    28,    29,    30,
      35,    19,     4,    36,     4,    37,     4,    38,     4,    39,
       0,     4,     5,     6,     7,     8,    15,    31,    32,    33,
      34,    19,    13,    14,    19,    13,    14,    19,    13,    14,
      19,    13,    14,    31,    20,    21,    22,    23,     5,    36,
       5,     6,    37,     7,    38,     8,    39,    16,    32,    32,
      33,    33
};
...
#line 126 "parser.y" /* yacc.c:1652  */
    {
					char all[64];
					sprintf(all,"%s=%d",(yyvsp[-2].variable),(yyvsp[0].int_value));
					enqueue(&vars,all);
				}
...
#line 137 "parser.y" /* yacc.c:1652  */
    {
					char all[64];
					sprintf(all,"%s=%f",(yyvsp[-2].variable),(yyvsp[0].float_value));
					enqueue(&vars,all);
				}
...
#line 153 "parser.y" /* yacc.c:1652  */
    {
					char all[64];
					sprintf(all,"%s=%lf",(yyvsp[-2].variable),(yyvsp[0].double_value));
					enqueue(&vars,all);
				}
...
#line 164 "parser.y" /* yacc.c:1652  */
    {
					char all[64];
					sprintf(all,"%s=%c",(yyvsp[-2].variable),(yyvsp[0].char_value));
					enqueue(&vars,all);
				}
